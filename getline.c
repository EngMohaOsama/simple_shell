...
/**
 * input_buf - cushions chained commands
 * @info: parameters for struct
 * @buf: parametrer address of buffer
 ...
 * @info: parameter of struct
 * @ptr: address of pointer parameter to buffer, preallocated or NULL
