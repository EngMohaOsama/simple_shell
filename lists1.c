...
/**
 * list_to_strings - An  array of strings for the list str
...
/**
 * node_starts_with - returns node that has got string starting with a prefix
 * @node: pointer to head of lists
 * @prefix: string to complement
 * @c: next charactersubsequently refix to match
 *
